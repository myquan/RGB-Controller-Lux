...
#define _18_AD_CONVERSION_CLOCK_6       (0x18U) /* fCLK/6 */
#define _20_AD_CONVERSION_CLOCK_5       (0x20U) /* fCLK/5 */
#define _28_AD_CONVERSION_CLOCK_4       (0x28U) /* fCLK/4 */
#define _30_AD_CONVERSION_CLOCK_2       (0x30U) /* fCLK/2 */
#define _38_AD_CONVERSION_CLOCK_1       (0x38U) /* fCLK */
...
#define _15_AD_INPUT_CHANNEL_21_24      (0x15U) /* ANI21 - ANI24 */
#define _16_AD_INPUT_CHANNEL_22_25      (0x16U) /* ANI22 - ANI25 */
#define _17_AD_INPUT_CHANNEL_23_26      (0x17U) /* ANI23 - ANI26 */
#define _18_AD_INPUT_CHANNEL_24_27      (0x18U) /* ANI24 - ANI27 */
#define _19_AD_INPUT_CHANNEL_25_28      (0x19U) /* ANI25 - ANI28 */
#define _1A_AD_INPUT_CHANNEL_26_29      (0x1AU) /* ANI26 - ANI29 */
#define _1B_AD_INPUT_CHANNEL_27_30      (0x1BU) /* ANI27 - ANI30 */
...
#define _00_AD_POSITIVE_AVDD            (0x00U) /* use AVDD as VREF(+) */
...
#define _00_AD_NEGATIVE_AVSS            (0x00U) /* use AVSS as VREF(-) */
...
#define _00_AD_RESOLUTION_12BIT         (0x00U) /* 12 bits */
...
#define _01_AD_ADPC_0ANALOG             (0x01U) /* ANI0 - ANI8 (all digital) */
...
typedef enum
{
    ...
    ADCHANNEL8, ADCHANNEL16 = 16U, ADCHANNEL17, ADCHANNEL18, ADCHANNEL19, ADCHANNEL20, ADCHANNEL21, 
    ADCHANNEL22, ADCHANNEL23, ADCHANNEL24, ADCHANNEL25, ADCHANNEL26, ADCHANNEL27, ADCHANNEL28, 
    ADCHANNEL29, ADCHANNEL30, ADTEMPERSENSOR0 = 128U, ADINTERREFVOLT
} ad_channel_t;
typedef enum
{
    ADNORMALINPUT,
