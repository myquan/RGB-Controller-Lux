...
Macro definitions
***********************************************************************************************************************/
#define _F3_PM0_DEFAULT         (0xF3U) /* PM0 default value */
#define _80_PM1_DEFAULT         (0x80U) /* PM1 default value */
...
#define _C0_PMC1_DEFAULT        (0xC0U) /* PMC1 default value */
#define _FC_PMC3_DEFAULT        (0xFCU) /* PMC3 default value */
#define _FD_PMC4_DEFAULT        (0xFDU) /* PMC4 default value */
#define _FC_PMC5_DEFAULT        (0xFCU) /* PMC5 default value */
#define _FE_PMC7_DEFAULT        (0xFEU) /* PMC7 default value */
