...
#pragma interrupt INTIIC20 r_iic20_interrupt
...
extern uint8_t gestureBuf[1];
uint8_t gI2CEnd=0; //signify the end of I2C transmission.
uint8_t gIICA0Done=0;//signify the end of IICA0 transmission.
/* End user code. Do not edit comment generated here */
...
{
    /* Start user code. Do not edit comment generated here */
	while(g_uart1_rx_count>0){
		buffGesture[headGesture]= gestureBuf[0];
		headGesture++;
		headGesture=headGesture%BuffGestureSize;
		gp_uart1_rx_address--; 
		g_uart1_rx_count=0;
	}
